...
// Fetch data from the 'barcode' table where quantity is 0
$sql = "SELECT * FROM barcode WHERE quantity = 0";
            ...
            <nav class="navbar navbar-expand">
                <div class="collapse navbar-collapse justify-content-between">
                    ...
                    <ul class="navbar-nav header-right main-notification">
                        ...
                        <li class="nav-item dropdown notification_dropdown show">
                            <a class="nav-link  ai-icon" href="./items.php" role="button"
